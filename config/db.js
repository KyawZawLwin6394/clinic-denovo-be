...
const config = {
  development: {
    ...
    uploadsURI: ['./uploads/cherry-k/img', './uploads/cherry-k/history', './uploads/cherry-k/before', './uploads/cherry-k/after', './uploads/cherry-k/consent', './uploads/cherry-k/payment'],
    dbName: 'cherry-k',
    maxLoginAttempts: 5,
    lockTime: 30 * 60 * 1000,
