...
const config = {
  development: {
    ...
    uploadsURI: ['./uploads/cherry-k/img', './uploads/cherry-k/excel', './uploads/cherry-k/history', './uploads/cherry-k/before', './uploads/cherry-k/after', './uploads/cherry-k/consent', './uploads/cherry-k/payment', './uploads/cherry-k/email'],
    dbName: 'cherry-k',
    maxLoginAttempts: 5,
    lockTime: 30 * 60 * 1000,
