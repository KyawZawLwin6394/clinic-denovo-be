...
module.exports = (app) => {
    ...
    app.route('/api/treatment-vouchers/get-date').get(catchError(treatmentVoucher.getwithExactDate))
    app.route('/api/treatment-vouchers/TV-Filter').get(catchError(treatmentVoucher.TreatmentVoucherFilter))
    app.route('/api/treatment-vouchers/treatment-selection/:id').get(catchError(treatmentVoucher.getTreatmentVoucherWithTreatmentID))
};
